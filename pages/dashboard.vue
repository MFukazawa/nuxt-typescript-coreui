            ...
            <b-col sm="6" lg="4">
              ...
              <ul class="horizontal-bars type-2">
                ...
                <li>
                  ...
                  <span class="value"
                    >191,235 <span class="text-muted small">(56%)</span></span
                  >
                  <div class="bars">
                    <b-progress
                      height="{}"
                ...
                <li>
                  ...
                  <span class="value"
                    >51,223 <span class="text-muted small">(15%)</span></span
                  >
                  <div class="bars">
                    <b-progress
                      height="{}"
                ...
                <li>
                  ...
                  <span class="value"
                    >37,564 <span class="text-muted small">(11%)</span></span
                  >
                  <div class="bars">
                    <b-progress
                      height="{}"
                ...
                <li>
                  ...
                  <span class="value"
                    >27,319 <span class="text-muted small">(8%)</span></span
                  >
                  <div class="bars">
                    <b-progress
                      height="{}"
            ...
            <b-col sm="6" lg="4">
              ...
              <ul class="icons-list">
                <li>
                  ...
                  <div class="actions">
                    <b-button variant="link" class="text-muted"
                ...
                <li class="divider text-center">
                  <b-button size="sm" variant="link" class="text-muted"
                    ><i class="icon-options"></i
                  ></b-button>
                </li>
              </ul>
